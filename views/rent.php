                ...
                <form action="" method="POST" novalidate>
                    <fieldset>
                        ...
                        <div class="form-group text-white fw-bold">
                            ...
                            <input type="text" class="form-control" name="lastname" id="lastname" value="" placeholder="Entrez votre nom " maxlength="50" autocomplete="family-name" pattern="<?= REGEX_LASTNAME ?>" required>
                        ...
                        <div class="form-group text-white fw-bold">
                            ...
                            <input type="text" class="form-control" name="firstname" id="firstname" value="" placeholder="Entrez votre nom " maxlength="50" autocomplete="given-name" pattern="<?= REGEX_FIRSTNAME ?>" required>
                        ...
                        <div class="form-group text-white fw-bold">
                            ...
                            <input type="email" class="form-control" name="email" id="email" placeholder="Entrez votre mail" maxlength="120" value="" autocomplete="email" pattern="<?= REGEX_EMAIL?>" required>
                        ...
                        <div class="form-group text-white fw-bold">
                            ...
                            <input type="text" class="form-control" name="phone" id="phone" value="" maxlength="10" placeholder="Ex: 0322541202" pattern="<?= REGEX_PHONE?>" autocomplete="tel" required>
                        ...
                        <div class="form-group text-white fw-bold">
                            ...
                            <input type="date" class="form-control" name="startdate" id="startdate" min="<?= $currentDate ?>" autocomplete="bday" required>
                            <p class="error"> <?= $errors['startdate'] ?? '' ?> </p>
                        </div>
                        <!-- Partie date fin réservation -->
                        <div class="form-group text-white fw-bold">
                            <label for="enddate" class="form-label mt-4">Fin réservation *:</label>
                            <input type="date" class="form-control" name="enddate" id="enddate" min="<?= $currentDate ?>" autocomplete="bday" required>
