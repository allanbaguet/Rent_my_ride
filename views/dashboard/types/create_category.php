<div class="container-fluid">
    ...
    <h1 class="text-center mb-4">Ajout de catégorie</h1>
    <div class="row">
        <div class="col-2"></div>
        <div class="col-8">
            <form method="POST">
                ...
                <div class="mb-3 row my-5">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control type" id="type" name="type" value="" pattern="[A-Za-zÀ-ÿ].{1,30}" required>
                        <div id="typeHelp" class="form-text error d-none text-danger">Le champ n'est pas valide</div>
                        <p class="error"> <?= $errors['type'] ?? '' ?> </p>
                    </div>
                </div>
                <div class="d-flex justify-content-center">
                    <button type="submit" class="btn button-add text-white">Ajout</button>
                </div>
            </form>
        </div>
    </div>
