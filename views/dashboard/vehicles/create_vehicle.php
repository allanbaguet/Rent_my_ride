    ...
    <div class="row">
        ...
        <div class="col-8">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 row my-5">
                    <label for="picture" class="col-sm-4 col-form-label fw-semibold title-input fs-5">Image</label>
                    <div class="col-sm-8">
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" class="btn text-white button-add">Ajout</button>
                </div>
            </form>
        </div>
    </div>
