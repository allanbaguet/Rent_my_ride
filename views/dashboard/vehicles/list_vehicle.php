<div class="container-fluid">
    ...
    <div class="d-flex justify-content-center">
        <a href="/controllers/dashboard/vehicles/create_vehicle_controller.php">
            <button type="button" class="btn button-add text-white mb-4">+ Ajout de véhicule</button>
        </a>
    </div>
    <div class="row my-5">
        <div class="col-2"></div>
            ...
            <div class="table-responsive-md-sm shadow-table">
                <table class="table table-bordered table-hover">
                    <thead class="custom-thead">
                        <tr class="text-start">
                            <th scope="col" class="text-white">Catégorie
                                <button class="btn btn-transparent">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="white" class="bi bi-chevron-bar-contract" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M3.646 14.854a.5.5 0 0 0 .708 0L8 11.207l3.646 3.647a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 0 0 0 .708zm0-13.708a.5.5 0 0 1 .708 0L8 4.793l3.646-3.647a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 0-.708zM1 8a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 0 1h-13A.5.5 0 0 1 1 8z" />
                                    </svg>
                                </button>
                            <th scope="col" class="text-white">Marque
                            ...
                            <th scope="col" class="text-white">Modèle
                                <a href="?order=<?= $order == 'ASC' ? 'DESC' : 'ASC' ?>">
                                    <button class="btn btn-transparent">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="white" class="bi bi-chevron-bar-contract" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M3.646 14.854a.5.5 0 0 0 .708 0L8 11.207l3.646 3.647a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 0 0 0 .708zm0-13.708a.5.5 0 0 1 .708 0L8 4.793l3.646-3.647a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 0-.708zM1 8a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 0 1h-13A.5.5 0 0 1 1 8z" />
                            ...
                            <th scope="col" class="text-white">Modification
                            <a href="?order=<?= $order == 'ASC' ? 'DESC' : 'ASC' ?>">
                                    <button class="btn btn-transparent">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-chevron-bar-contract" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M3.646 14.854a.5.5 0 0 0 .708 0L8 11.207l3.646 3.647a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 0 0 0 .708zm0-13.708a.5.5 0 0 1 .708 0L8 4.793l3.646-3.647a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 0-.708zM1 8a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 0 1h-13A.5.5 0 0 1 1 8z" />
                                        </svg>
                                    </button>
                                </a>
                    ...
                    <tbody class="table-group-divider custom-tbody">
                        ...
                        foreach ($getVehicleList as $vehicleList) { ?>
                            <tr class="text-center">
                                <th scope="row" class="custom-table-text"><?php echo $vehicleList->type ?></th>
                ...
                <table class="table table-bordered table-hover">
                    <thead class="custom-thead">
                        <tr class="text-center table-active">
                            ...
                            <th scope="col" class="text-white">Marque</th>
                            <th scope="col" class="text-white">Modèle</th>
                    ...
                    <tbody class="table-group-divider custom-tbody">
                        ...
                        foreach ($getVehicleArchived as $vehicleArchived) { ?>
                            <tr class="text-center">
                                <th scope="row" class="custom-table-text"><?php echo $vehicleArchived->type ?></th>
