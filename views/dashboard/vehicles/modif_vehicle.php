        ...
        <div class="col-8">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 row my-5">
                    <label for="brand" class="col-sm-4 col-form-label title-input fw-semibold fs-5">Marque</label>
                    <div class="col-sm-8">
                ...
                <div class="mb-3 row my-5">
                    <label for="model" class="col-sm-4 col-form-label title-input fw-semibold fs-5">Modèle</label>
                    <div class="col-sm-8">
                ...
                <div class="mb-3 row my-5">
                    <label for="registration" class="col-sm-4 col-form-label title-input fw-semibold fs-5">Immatriculation</label>
                    <div class="col-sm-8">
                ...
                <div class="mb-3 row my-5">
                    <label for="mileage" class="col-sm-4 col-form-label title-input fw-semibold fs-5">Kilométrage</label>
                    <div class="col-sm-8">
                ...
                <div class="mb-3 row my-5">
                    <label for="type" class="col-sm-4 col-form-label title-input fw-semibold fs-5">Catégorie</label>
                    <div class="col-sm-8">
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" class="btn text-white button-add">Modifier</button>
                </div>
            </form>
        </div>
    </div>
